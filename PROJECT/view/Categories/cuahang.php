    ...
    <div class="header">
        ...
        <main>
            <div class="main">
                ...
                <input class="search" type="text" id="search" placeholder="Tìm kiếm....." onchange="searchProducts()">
                <div id="notFoundMessage" style="display:none; text-align: center; height: 350px;">Sản phẩm không tồn tại.</div>
                <div class="product">
                    ...
                    <div class="content_product">
                       ...
                       echo'        <div class="card_product" data-name ="'.$productName.'">'; 
