...
$id = $_SESSION['name_id'];
$sql = "SELECT transaction.*, users.name, users.phone, users.address FROM transaction join users on transaction.users_id = users.id WHERE users_id = $id";
$trans = $db->fetchsql($sql);
?>
<?php require_once __DIR__ . '/layouts/header.php'; ?>

<div class="col-md-12 bor">
	<section class="box-main1 container" style="min-height: 400px;">
